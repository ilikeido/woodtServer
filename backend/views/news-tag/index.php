...
$modelLabel = new \backend\models\NewsTag();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'news-tag-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('news-tag/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "news-tag-form", "class"=>"form-horizontal", "action"=>Url::toRoute("news-tag/save")]); ?>                      
                 
          <input type="hidden" class="form-control" id="id" name="NewsTag[id]" />
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" name="NewsTag[name]" placeholder="必填" />
              </div>
          ...
          <div id="flag_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="flag" name="NewsTag[flag]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="sort_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="sort" name="NewsTag[sort]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('news-tag/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#news-tag-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('news-tag/create')?>" : "<?=Url::toRoute('news-tag/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
		data:{id:id},
