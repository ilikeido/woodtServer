...
use backend\models\DemandArea;

$modelLabel = new \backend\models\DemandArea();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'demand-area-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('demand-area/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "demand-area-form", "class"=>"form-horizontal", "action"=>Url::toRoute("demand-area/save")]); ?>                      
                 
          <input type="hidden" class="form-control" id="id" name="DemandArea[id]" />
          ...
          <div id="sort_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="sort" name="DemandArea[sort]" placeholder="" />
              </div>
          ...
          <div id="area_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="area" name="DemandArea[area]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function orderby(field, op){
 ...
 function searchAction(){
		$('#demand-area-search-form').submit();
	}
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('demand-area/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('demand-area/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#demand-area-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('demand-area/create')?>" : "<?=Url::toRoute('demand-area/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
