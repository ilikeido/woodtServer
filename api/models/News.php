 ...
 */
class News extends \api\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['title', 'category_id', 'tags', 'parse_content'], 'required'],
            [['category_id', 'cover_id', 'view', 'uid', 'sort', 'flag'], 'integer'],
            [['parse_content'], 'string'],
            [['create_time'], 'safe'],
            [['title', 'description', 'tags', 'cover_thumb_url'], 'string', 'max' => 255]
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', '编号'),
            'title' => Yii::t('app', '标题'),
            'description' => Yii::t('app', '来源'),
            'category_id' => Yii::t('app', '分类'),
            'tags' => Yii::t('app', '标签'),
            'cover_id' => Yii::t('app', '封面编号'),
            'cover_thumb_url' => Yii::t('app', '封面地址'),
