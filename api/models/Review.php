 ...
 */
class Review extends \api\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['uid', 'content', 'nickname', 'type', 'source_id'], 'required'],
            [['uid', 'flag', 'source_id'], 'integer'],
            [['content'], 'string'],
            [['create_time'], 'safe'],
            [['nickname', 'avatar', 'type'], 'string', 'max' => 255]
        ];
    }
